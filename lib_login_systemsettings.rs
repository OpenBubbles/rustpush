...
pub trait OSConfig: Sync + Send {
    ...
    fn get_gsa_config(&self, push: &APSState) -> LoginClientInfo {
        LoginClientInfo {
            ak_context_type: "icloud".to_string(),
            client_app_name: "AppleIDSettings".to_string(),
            client_bundle_id: "com.apple.systempreferences.AppleIDSettings".to_string(),
            mme_client_info_akd: self.get_adi_mme_info("com.apple.AuthKit/1 (com.apple.akd/1.0)"),
            mme_client_info: self.get_adi_mme_info("com.apple.AuthKit/1 (com.apple.systempreferences.AppleIDSettings/1)"),
